...
- (void)addEarthquakeHeatmap {
  NSURL *earthquakesURL =
      [NSURL URLWithString:@"https://maplibre.org/maplibre-gl-js/docs/assets/earthquakes.geojson"];
...
- (NSURL *)radarImageURL:(int)index {
  return [NSURL
      URLWithString:
          [NSString stringWithFormat:@"https://maplibre.org/maplibre-gl-js/docs/assets/radar%d.gif",
                                     index]];
}
